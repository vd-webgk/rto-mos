...
<tfoot><tr><td colspan="2">
	<?if(COption::GetOptionString('aspro.optimus', 'SHOW_LICENCE', 'Y', SITE_ID) == "Y" && !$arResult["ID"] ):?>
		<div class="subscribe_licenses">
			<div class="licence_block filter label_block">
				...
				<?endif;?>
				<input type="checkbox" id="licenses_subscribe" <?=($_POST["licenses_subscribe"] ? "checked" : ($_POST ? "" : (COption::GetOptionString("aspro.optimus", "LICENCE_CHECKED", "N") == "Y" ? "checked" : "")));?> name="licenses_subscribe" value="Y">
