...
$arCounters = COptimus::updateBasketCounters(array('READY' => array('COUNT' => $normalCount, 'TITLE' => COptimus::clearFormatPrice($arResult['allSum_FORMATED']), 'HREF' => $arParams["PATH_TO_BASKET"]), 'DELAY' => array('COUNT' => $delayCount, 'TITLE' => COptimus::clearFormatPrice($arResult["DELAY_PRICE"]["SUMM_FORMATED"]), 'HREF' => $arParams["PATH_TO_BASKET"]), 'COMPARE' => array('COUNT' => $compareCount, 'HREF' => $arParams["PATH_TO_COMPARE"]), 'PERSONAL' => array('HREF' => $arParams["PATH_TO_AUTH"])));
?>
