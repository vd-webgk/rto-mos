...
<form class="form subform">
	...
	<div class="form_footer">
		<input type="submit" class="button medium" value="<?=\Bitrix\Main\Localization\Loc::getMessage('SUBSCRIBE_SEND');?>" name="web_form_submit">
	</div>
</form>
<script type="text/javascript">
	$('input[name="siteId"]').val(arOptimusOptions['SITE_ID']);
					...
					BX.ajax.submitAjax($('form.subform')[0], {
						...
						onsuccess: function(response){
							...
							if(resultForm.success)
							{
								...
								getActualBasket();
								$.ajax({
									url: arOptimusOptions['SITE_DIR'] + 'ajax/subscribe_sync.php',
									dataType: "json",
									type: "POST",
									data: BX.ajax.prepareData({
										...
										itemId: '<?=$itemID;?>',
										itemEmail: email,
										siteId: arOptimusOptions['SITE_ID']
									}),
									success: function(id){
